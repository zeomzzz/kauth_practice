...
public class SwaggerConfig {
	...
	@Bean
	public Docket api() {
		final ApiInfo apiInfo = new ApiInfoBuilder().title("Kauth Practice API")
		...
		return new Docket(DocumentationType.SWAGGER_2) // Swagger 2.0 기반의 문서 작성
				...
				.apis(RequestHandlerSelectors.basePackage("com.zeomzzz.kauthPractice.controller"))// 대상으로하는 api 설정
